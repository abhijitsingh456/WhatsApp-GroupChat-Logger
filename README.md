A NodeJS script to auto save WhatsApp group messages locally in a csv file along with images/documents in a local folder
...
7. Messages from that group will now be stored in a csv file (name of the file will be the GROUP ID) under the directory name 'group_chats' and images/documents will be saved under the directory name 'downloads' with its name being the MESSAGE ID.
